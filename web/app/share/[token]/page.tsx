  ...
  return (
    <main className="min-h-screen" style={{ background: "var(--bg)" }}>
      <header className="border-b px-8 py-4 flex items-center gap-3" style={{ borderColor: "var(--border-solid)", background: "rgba(255,255,255,0.95)" }}>
        ...
        <span className="font-bold text-sm text-slate-900">MapTheModel — Shared Report</span>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        ...
        <p className="text-center text-[11px] text-slate-400 pt-4">
          Generated by <span className="font-bold text-slate-500">MapTheModel</span> — AI brand visibility analytics
        </p>
      </div>
    </main>
  );
