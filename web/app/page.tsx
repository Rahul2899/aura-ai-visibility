...
function exportPDF(brands: BrandRow[]) {
  ...
  const html = `<!doctype html><html><head><meta charset="utf-8"><title>MapTheModel Visibility Report</title>
  <style>
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    <div class="head">
      <div><div class="brandmark">MapTheModel</div><div class="sub">AI Brand Visibility Report</div></div>
    ...
    <div class="foot">Generated by MapTheModel. Results reflect non-deterministic AI responses and may vary between runs.</div>
  </body></html>`;
    ...
    <main className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <header className="border-b px-5 sm:px-8 py-4 flex items-center justify-between sticky top-0 z-10 backdrop-blur-md" style={{ borderColor: "var(--border-solid)", background: "rgba(255,255,255,0.95)" }}>
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="font-bold text-sm text-slate-900 tracking-tight group-hover:text-[var(--accent)] transition-colors">MapTheModel</span>
        </Link>
        {admin ? (
          <button
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 py-6 space-y-5">
        ...
        <Reveal>
          <section className="card p-6 sm:p-8">
            <h2 className="font-bold text-lg text-slate-900 text-center">How MapTheModel measures AI visibility</h2>
      ...
      <footer className="border-t mt-8 py-6 px-6 text-center" style={{ borderColor: "var(--border-solid)" }}>
        <p className="text-xs text-slate-400 font-medium">
          <span className="font-bold text-slate-500">MapTheModel</span> · AI brand visibility analytics ·
